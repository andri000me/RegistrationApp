        ...
        <div class="panel-body">
                ...
                <table id="datas" class="table datatable-html">
                    ...
                    <?php } ?>
                        ...
                        <td> <a href="<?php echo base_url().'Keuangan/lihat_bukti_bayar/'.$row->id_bayar; ?>"  target="_blank"> <span class="btn btn-info btn-xsm">Lihat Bukti</span><a></td>
                    <?php
                        if($row->status_bayar=="selesai"){ ?>
                            <td>
                            <?php //<li class="btn btn-info btn-xsm" data-toggle="modal" data-target="#myModal1">?>
                                    <a href="<?php echo base_url().'Keuangan/lihat_nota_pdf/'.$row->id_bayar; ?>"  target="_blank">
                    ...
                    <?php }else if($row->status_bayar=="ditolak"){ ?>
                            ...
                            <span>-</span></td>
                    <?php } ?>
                        <td><b> <?php echo $row->nama_pegawai; ?> </b></td> 
                    </tr>
