...
<form name="form" class="form-horizontal" method="post" action="<?php echo base_url()?>Siswa/simpan_password" onSubmit="return validasi(this);">
			<div class="panel-body">
						<?php
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" name="username" value="<?php echo $row->nis;?>" readonly>
								</div>
							</div>
							<input type="hidden" class="form-control" name="pass" id="pass" value="<?php echo $row->password;?>">
							<div class="form-group">
								<label class="col-sm-3 control-label">Password Lama*</label>
								<div class="col-sm-5">
									<input type="password" placeholder="Password Lama" class="form-control" name="password" id="password" maxlength="20" required>
								</div>
							</div>
							<div class="form-group">
